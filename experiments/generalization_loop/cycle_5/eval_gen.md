# Generalization suite evaluation — cycle_5
...
| gen04_branch_explosion_with_recovery.json | I_EXPOSITION:0-0 | - | branch_explosion likely triggers (avg dup<0.20, distinct branches >=5 over loops 0-4) even though late synthesis recovers. | - | - |
...
| gen11_repeated_borderline_EN.json | I_EXPOSITION:0-0 | - | composite_EN: all 'borderline' family, penultimate-EN: no confirmed candidate (none in genuine band) | borderline_chain | borderline_no_recovery, borderline_no_recovery, borderline_no_recovery, borderline_with_recovery |
...
- detector_hits: {'branch_explosion': False, 'mild_stagnation': False, 'step_coherence_violation': False, 'penultimate_en_candidate': False, 'attractor_lock': False, 'borderline_chain': False, 'any_genuine_transformation_confirmed': False, 'any_recovered_after_high_eni': False, 'any_stuck_high_eni': False}
...
- detector_hits: {'branch_explosion': False, 'mild_stagnation': False, 'step_coherence_violation': False, 'penultimate_en_candidate': False, 'attractor_lock': False, 'borderline_chain': False, 'any_genuine_transformation_confirmed': True, 'any_recovered_after_high_eni': False, 'any_stuck_high_eni': False}
...
- detector_hits: {'branch_explosion': False, 'mild_stagnation': False, 'step_coherence_violation': False, 'penultimate_en_candidate': False, 'attractor_lock': True, 'borderline_chain': False, 'any_genuine_transformation_confirmed': True, 'any_recovered_after_high_eni': False, 'any_stuck_high_eni': False}
...
- detector_hits: {'branch_explosion': False, 'mild_stagnation': False, 'step_coherence_violation': False, 'penultimate_en_candidate': False, 'attractor_lock': False, 'borderline_chain': False, 'any_genuine_transformation_confirmed': False, 'any_recovered_after_high_eni': False, 'any_stuck_high_eni': False}
- composite_en_labels: []
- missed: ['branch_explosion likely triggers (avg dup<0.20, distinct branches >=5 over loops 0-4) even though late synthesis recovers.']  spurious: []
...
- detector_hits: {'branch_explosion': True, 'mild_stagnation': False, 'step_coherence_violation': False, 'penultimate_en_candidate': False, 'attractor_lock': False, 'borderline_chain': False, 'any_genuine_transformation_confirmed': False, 'any_recovered_after_high_eni': False, 'any_stuck_high_eni': False}
- composite_en_labels: []
...
- detector_hits: {'branch_explosion': False, 'mild_stagnation': False, 'step_coherence_violation': False, 'penultimate_en_candidate': False, 'attractor_lock': True, 'borderline_chain': False, 'any_genuine_transformation_confirmed': False, 'any_recovered_after_high_eni': False, 'any_stuck_high_eni': False}
...
- detector_hits: {'branch_explosion': False, 'mild_stagnation': False, 'step_coherence_violation': True, 'penultimate_en_candidate': False, 'attractor_lock': False, 'borderline_chain': False, 'any_genuine_transformation_confirmed': False, 'any_recovered_after_high_eni': False, 'any_stuck_high_eni': False}
- composite_en_labels: []
...
- phases: ['I_EXPOSITION:0-0']
- detector_hits: {'branch_explosion': False, 'mild_stagnation': False, 'step_coherence_violation': False, 'penultimate_en_candidate': False, 'attractor_lock': False, 'borderline_chain': True, 'any_genuine_transformation_confirmed': False, 'any_recovered_after_high_eni': False, 'any_stuck_high_eni': False}
- composite_en_labels: ['borderline_no_recovery', 'borderline_no_recovery', 'borderline_no_recovery', 'borderline_with_recovery']
- missed: ["composite_EN: all 'borderline' family", 'penultimate-EN: no confirmed candidate (none in genuine band)']  spurious: ['borderline_chain']
...
- phases: ['I_EXPOSITION:0-0']
- detector_hits: {'branch_explosion': False, 'mild_stagnation': False, 'step_coherence_violation': True, 'penultimate_en_candidate': False, 'attractor_lock': True, 'borderline_chain': False, 'any_genuine_transformation_confirmed': False, 'any_recovered_after_high_eni': False, 'any_stuck_high_eni': False}
- composite_en_labels: []
