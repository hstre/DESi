# Generalization suite evaluation — cycle_1_adv
...
| adv03_phase_iv_without_two_consecutive_low_en.json | I_EXPOSITION:0-0; II_FIRST_SATURATION_MODULATION:1-2; V_TERMINAL_CONVERGENCE:2-5 | II_FIRST_SATURATION_MODULATION∩V_TERMINAL_CONVERGENCE | - | penultimate_en_candidate, attractor_lock, any_genuine_transformation_confirmed | false_return_confirmed, genuine_transformation_confirmed, false_return_confirmed |
...
| adv06_false_penultimate_candidate.json | I_EXPOSITION:0-0; II_FIRST_SATURATION_MODULATION:1-3; III_DEVELOPMENT:2-2; V_TERMINAL_CONVERGENCE:4-6 | II_FIRST_SATURATION_MODULATION∩III_DEVELOPMENT | - | attractor_lock, any_genuine_transformation_confirmed | genuine_transformation_confirmed, genuine_transformation_unconfirmed, false_return_confirmed |
...
| adv09_late_recovery_after_apparent_lock.json | I_EXPOSITION:0-0; II_FIRST_SATURATION_MODULATION:2-2; III_DEVELOPMENT:6-8; IV_DEEPENING_ATTRACTOR:2-4; V_TERMINAL_CONVERGENCE:2-5 | II_FIRST_SATURATION_MODULATION∩IV_DEEPENING_ATTRACTOR; II_FIRST_SATURATION_MODULATION∩V_TERMINAL_CONVERGENCE; IV_DEEPENING_ATTRACTOR∩V_TERMINAL_CONVERGENCE | - | any_genuine_transformation_confirmed | false_return_confirmed, false_return_confirmed, genuine_transformation_confirmed |
...
- expected failure mode: `None`  expected risk: `None`
- expected detector hits: []
- phases: ['I_EXPOSITION:0-0', 'II_FIRST_SATURATION_MODULATION:1-2', 'V_TERMINAL_CONVERGENCE:2-5']
...
- expected failure mode: `None`  expected risk: `None`
- expected detector hits: []
- phases: ['I_EXPOSITION:0-0', 'II_FIRST_SATURATION_MODULATION:1-3', 'III_DEVELOPMENT:2-2', 'V_TERMINAL_CONVERGENCE:4-6']
...
- expected failure mode: `None`  expected risk: `None`
- expected detector hits: []
- phases: ['I_EXPOSITION:0-0', 'II_FIRST_SATURATION_MODULATION:2-2', 'III_DEVELOPMENT:6-8', 'IV_DEEPENING_ATTRACTOR:2-4', 'V_TERMINAL_CONVERGENCE:2-5']
- detector_hits: {'branch_explosion': False, 'mild_stagnation': False, 'step_coherence_violation': False, 'penultimate_en_candidate': False, 'attractor_lock': False, 'any_genuine_transformation_confirmed': True, 'any_recovered_after_high_eni': False, 'any_stuck_high_eni': False}
