...
Dies ist das Kernrepository. Die Governance-Mechanik — Ledger, Provenienz, Replay, `verify` —
funktioniert und tut, was sie beschreibt. Was **nicht** gehalten hat, ist der darüber hinausgehende
Anspruch: dass diese Schicht ein Modellurteil verbessert, beschränkt oder epistemische Vorgänge
zuverlässiger klassifiziert als das Modell selbst.
...
This is the core repository. The governance mechanics — ledger, provenance, replay, `verify` — work
and do what they say. What did **not** hold is the claim beyond that: that this layer improves,
constrains, or classifies better than the model itself.
