"""v3.18 — runtime regression: no patch, all hashes pinned."""
...
def test_no_runtime_module_imports_causal_naturalness() -> None:
    ...
    pattern = re.compile(r"causal_naturalness")
    for sub in forbidden:
        ...
        for p in sub_path.rglob("*.py"):
            ...
            assert not pattern.search(text), (
                f"{p} mentions causal_naturalness"
            )
