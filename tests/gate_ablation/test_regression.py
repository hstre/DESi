"""v3.21 — runtime regression: read-only, all hashes pinned."""
...
def test_no_runtime_module_imports_gate_ablation() -> None:
    ...
    pattern = re.compile(r"gate_ablation")
