"""v4.0 — runtime regression: read-only, all hashes pinned."""
...
def test_v3_artifact_hashes_pinned() -> None:
    ...
    assert _artifact_hash("v3_19") == "3cbde141b5d90a46"
    assert _artifact_hash("v3_20") == "02eb32df1f51b761"
    assert _artifact_hash("v3_21") == "f570c9e94770dfbc"
    assert _artifact_hash("v3_22") == "be039cd52c3de9b5"
    assert _artifact_hash("v3_23") == "0246444ccd8f96ef"


def test_no_runtime_module_imports_external_probe() -> None:
    ...
    pattern = re.compile(r"external_probe")
