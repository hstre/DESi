"""v3.23 — runtime regression: read-only, all hashes pinned."""
...
def test_no_runtime_module_imports_gate_latency() -> None:
    ...
    forbidden = (
        ...
        "gate_ablation", "gate_order",
    )
    pattern = re.compile(r"gate_latency")
