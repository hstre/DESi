"""v4.7 — protected benchmarks stable + historical pins
preserved."""
...
def test_v40_to_v46_historical_artifacts_preserved() -> None:
    """v4.7 must not rewrite any historical artifact file."""
