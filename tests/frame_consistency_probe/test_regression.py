"""v3.9 regression — runtime untouched, all prior hashes still pinned."""
...
def test_no_runtime_module_imports_frame_consistency_probe() -> None:
    ...
    pattern = re.compile(r"frame_consistency_probe")
    for sub in forbidden:
        ...
        for p in sub_path.rglob("*.py"):
            ...
            assert not pattern.search(text), (
                f"{p} mentions frame_consistency_probe — directive violation"
            )
