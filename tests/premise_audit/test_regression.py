"""v3.20 — runtime regression: read-only, all hashes pinned."""
...
def test_artifact_hashes_pinned() -> None:
    # Aufgabe 8: protected hashes bit-identical
...
def test_no_runtime_module_imports_premise_audit() -> None:
    ...
    pattern = re.compile(r"premise_audit")
