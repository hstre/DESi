"""v4.5 — protected benchmarks stable + historical pins
unchanged."""
...
def test_v40_v41_v42_v43_v44_historical_artifacts_preserved() -> None:
    """v4.5 must not rewrite the historical artifact files."""
