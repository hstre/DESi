"""v3.8 regression — runtime untouched, all prior hashes still pinned."""
...
def test_no_runtime_module_imports_frame_context_probe() -> None:
    ...
    pattern = re.compile(r"frame_context_probe")
    for sub in forbidden:
        ...
        for p in sub_path.rglob("*.py"):
            ...
            assert not pattern.search(text), (
                f"{p} mentions frame_context_probe — directive violation"
            )
