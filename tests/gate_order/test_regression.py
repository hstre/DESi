"""v3.22 — runtime regression: read-only, all hashes pinned."""
...
def test_no_runtime_module_imports_gate_order() -> None:
    ...
    pattern = re.compile(r"gate_order")
