...
from .enums import RecommendationOutcome, WarrantFailure
    ...
    *,
    ...
    return (
        ...
        (
            ...
            f"and unknown_fraction="
            f"{distribution.unknown_fraction} both fail"
        ),
    )


def build_v46_report(
    *, started_at: datetime, finished_at: datetime,
    ...
    # Aufgabe 10 reads ``contamination_count`` as the safe-
    # probes-only metric; per-probe contamination is reported
    # separately in probe_rescue.
