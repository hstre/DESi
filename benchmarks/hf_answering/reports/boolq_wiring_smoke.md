# BoolQ answering — constant_baseline(False) (real QA benchmark on the periphery)
...
| split | `validation` |
| model | `constant_baseline(False)` (backend `baseline`) |
| examples | 100 |
| answered / unparsed / errors | 100 / 0 / 0 |
| **exact bool accuracy** | **0.300** (of answered) |
| confusion (pos=True) | TP=0 TN=30 FP=0 FN=70 |
| elapsed | 0.0s |
| est. cost | $0.000000 |
